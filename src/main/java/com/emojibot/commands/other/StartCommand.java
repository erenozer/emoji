...
public class StartCommand extends EmojiCommand {
    ...
    public void run(SlashCommandInteractionEvent event) {
        ...
        .setAuthor(localization.getMsg("start_command", "hi_there"), "https://discord.com/oauth2/authorize?client_id=414878659267133445")
        ...
        .setDescription(localization.getMsg("start_command", "desc"))
        .addField(localization.getMsg("start_command", "featured_command"), localization.getMsg("start_command", "featured_desc"), false)
        .addField(localization.getMsg("start_command", "all_commands"), localization.getMsg("start_command", "all_commands_desc"), false)
        .setColor(BotConfig.getGeneralEmbedColor())
        .setFooter(localization.getMsg("start_command", "made_with"), event.getJDA().getSelfUser().getAvatarUrl())
        .setImage("https://cdn.discordapp.com/attachments/730414657478721607/733409659612037232/emoji.png")
        .build();
        
        Button inviteButton = Button.of(ButtonStyle.LINK, "https://discord.com/oauth2/authorize?client_id=414878659267133445", localization.getMsg("start_command", "add_me_to_server"), Emoji.fromFormatted("<:emoji:728286263429300274>"));
        Button serverButton = Button.of(ButtonStyle.LINK, "https://discord.gg/U5v2csS", localization.getMsg("start_command", "join_support_server"), Emoji.fromUnicode("❓"));
